...
import { Button, FormControl, Input, ModalBody, ModalCloseButton, ModalFooter, ModalHeader, Spinner, useDisclosure } from "@chakra-ui/react";
      ...
      <>
         ...
         <Modal
            ...
            <ModalHeader className="flex items-center justify-center ">
               <h1 className="text-[28px] sm:text-[35px] font-Work w-[100%] text-center font-[400] mt-[10px]">Create Group Chat</h1>
            </ModalHeader>
