...
const UpdateGroupChatModal = ({ handleFetchMessages }) => {
   ...
   const handleAddUser = async (user1) => {
      ...
      try {
         setLoading(true);
         const { data } = await axios.put("/chat/group/add", { chatId: selectedChat?._id, userId: user1?._id }, config);
      ...
      <>
         ...
         <Modal
            ...
            <ModalHeader className="flex items-center justify-center ">
               <h1 className="text-[28px] sm:text-[35px] font-Work w-[100%] text-center font-[400] mt-[10px]">{selectedChat?.chatName}</h1>
            </ModalHeader>
