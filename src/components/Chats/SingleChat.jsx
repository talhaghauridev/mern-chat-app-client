...
const SingleChat = () => {
   ...
   const { user, selectedChat, setSelectedChat, notification, setNotification, fetchAgain, setFetchAgain, latestMessages, setLatestMessages } =
      ChatState();
   ...
   const updateLatestMessages = (newMessage) => {
      setLatestMessages((prevMessages) => {
         ...
         const existingMessageIndex = prevMessages.findIndex(
            (msg) => msg.sender._id === newMapMessage.sender._id && msg.chat._id === newMapMessage.chat._id
         );
         ...
         if (existingMessageIndex !== -1) {
            ...
            return [...prevMessages.filter((item) => item?.chat?._id !== newMapMessage.chat._id), newMapMessage];
         }
      });
   };
               ...
               <div className="absolute w-full  items-center justify-center flex bottom-[85px]">
                  <div
                     className={cn(
                        ...
                        !isScrolledToBottom && !loading ? "bottom-[85px] opacity-1  " : "bottom-0 opacity-0 "
                     )}>
                     <button
